...
var Core = function(options) {
   ...
   var runSideMenu = function(options) {
      ...
      $('body').on("click", ".sidebar-toggle-mini", function (e) {
      ...
      $('#main').on("click", ".sidebar-menu-toggle", function (e) {
       //$('body').on("click", ".sidebar-menu-toggle", function (e) {
      ...
      $('#main').on("click", ".sidebar-menu li a.accordion-toggle", function (e) {
      //$('body').on("click", ".sidebar-menu li a.accordion-toggle", function (e) {
   ...
   var runHeader = function() {
      ...
      $('body').on("click", ".topbar-menu-toggle", function () {
   ...
   var runFormElements = function() {
      ...
      $('body').on('click', '.dropdown-menu .nav-tabs li a', function(e) {
      ...
      $('body').on('click', '.dropdown-menu .btn-group-nav a', function(e) {
