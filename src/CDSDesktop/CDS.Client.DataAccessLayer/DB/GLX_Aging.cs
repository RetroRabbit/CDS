...
namespace CDS.Client.DataAccessLayer.DB
{
    ...
    public partial class GLX_Aging : INotifyPropertyChanged, IBaseEntity
    { 
        ...
        public GLX_Aging()
        {
            this.GLX_History = new List<GLX_History>();
    	...
    	public virtual ICollection<GLX_History> GLX_History { get; set; }
        [System.Xml.Serialization.XmlIgnore]
