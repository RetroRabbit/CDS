...
namespace CDS.Client.DataAccessLayer.DB
{
    ...
    public partial class HumanResourcesEntityTables : DbContext /*ExtenderContext*/
    {
        public HumanResourcesEntityTables(string connection)
            : base(connection)
        {
    	}
    
    	public HumanResourcesEntityTables(DbConnection connection, bool ownsConnection)
            : base(connection, ownsConnection)
        {
        }
    
    	public HumanResourcesEntityTables()
            : base("name=HumanResourcesEntityTables")
        {
        }
        ...
        public DbSet<HRS_Employee> HRS_Employee { get; set; }
        public DbSet<HRS_Role> HRS_Role { get; set; }
    }
}
