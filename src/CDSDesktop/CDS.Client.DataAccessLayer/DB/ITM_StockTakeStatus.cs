...
namespace CDS.Client.DataAccessLayer.DB
{
    ...
    public partial class ITM_StockTakeStatus : INotifyPropertyChanged, IBaseEntity
    { 
        ...
        public ITM_StockTakeStatus()
        {
            this.ITM_StockTake = new List<ITM_StockTake>();
        }
    	...
    	public virtual ICollection<ITM_StockTake> ITM_StockTake { get; set; }
    }
}
