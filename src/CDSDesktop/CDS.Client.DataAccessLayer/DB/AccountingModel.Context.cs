...
namespace CDS.Client.DataAccessLayer.DB
{
    ...
    public partial class AccountingEntityTables : DbContext /*ExtenderContext*/
    {
        public AccountingEntityTables(string connection)
            : base(connection)
        {
    	}
    
    	public AccountingEntityTables(DbConnection connection, bool ownsConnection)
            : base(connection, ownsConnection)
        {
        }
    
    	public AccountingEntityTables()
            : base("name=AccountingEntityTables")
        {
        }
        ...
        public DbSet<GLX_Account> GLX_Account { get; set; }
        public DbSet<GLX_Aging> GLX_Aging { get; set; }
        public DbSet<GLX_Budget> GLX_Budget { get; set; }
        public DbSet<GLX_BulkEntryRule> GLX_BulkEntryRule { get; set; }
        public DbSet<GLX_Header> GLX_Header { get; set; }
        public DbSet<GLX_History> GLX_History { get; set; }
        public DbSet<GLX_JournalType> GLX_JournalType { get; set; }
        public DbSet<GLX_Line> GLX_Line { get; set; }
        public DbSet<GLX_Recon> GLX_Recon { get; set; }
        public DbSet<GLX_SiteAccount> GLX_SiteAccount { get; set; }
        public DbSet<GLX_SystemAccountType> GLX_SystemAccountType { get; set; }
        public DbSet<GLX_Tax> GLX_Tax { get; set; }
        public DbSet<GLX_Type> GLX_Type { get; set; }
    }
}
