...
namespace CDS.Client.DataAccessLayer.DB
{
    ...
    public partial class OrderingEntityTables : DbContext /*ExtenderContext*/
    {
        public OrderingEntityTables(string connection)
            : base(connection)
        {
    	}
    
    	public OrderingEntityTables(DbConnection connection, bool ownsConnection)
            : base(connection, ownsConnection)
        {
        }
    
    	public OrderingEntityTables()
            : base("name=OrderingEntityTables")
        {
        }
        ...
        public DbSet<AOR_Order> AOR_Order { get; set; }
        public DbSet<AOR_OrderLine> AOR_OrderLine { get; set; }
    }
}
