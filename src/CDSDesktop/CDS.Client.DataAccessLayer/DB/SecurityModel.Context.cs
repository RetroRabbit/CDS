...
namespace CDS.Client.DataAccessLayer.DB
{
    ...
    public partial class SecurityEntityTables : DbContext /*ExtenderContext*/
    {
        public SecurityEntityTables(string connection)
            : base(connection)
        {
    	}
    
    	public SecurityEntityTables(DbConnection connection, bool ownsConnection)
            : base(connection, ownsConnection)
        {
        }
    
    	public SecurityEntityTables()
            : base("name=SecurityEntityTables")
        {
        }
        ...
        public DbSet<SEC_Access> SEC_Access { get; set; }
        public DbSet<SEC_Role> SEC_Role { get; set; }
        public DbSet<SEC_RoleAccess> SEC_RoleAccess { get; set; }
        public DbSet<SEC_UserRole> SEC_UserRole { get; set; }
