...
namespace CDS.Client.DataAccessLayer.DB
{
    ...
    public partial class SystemEntityTables : DbContext /*ExtenderContext*/
    {
        public SystemEntityTables(string connection)
            : base(connection)
        {
    	}
    
    	public SystemEntityTables(DbConnection connection, bool ownsConnection)
            : base(connection, ownsConnection)
        {
        }
    
    	public SystemEntityTables()
            : base("name=SystemEntityTables")
        {
        }
    	...
    	private int SubmitChanges(System.Data.Entity.Core.Objects.SaveOptions saveOptions)
        {
            ...
            ((IObjectContextAdapter)this).ObjectContext.DetectChanges();
        ...
        public DbSet<SYS_Abbreviation> SYS_Abbreviation { get; set; }
        public DbSet<SYS_Address> SYS_Address { get; set; }
        public DbSet<SYS_DOC_Header> SYS_DOC_Header { get; set; }
        public DbSet<SYS_DOC_Line> SYS_DOC_Line { get; set; }
        public DbSet<SYS_DOC_Type> SYS_DOC_Type { get; set; }
        public DbSet<SYS_Entity> SYS_Entity { get; set; }
        public DbSet<SYS_Layout> SYS_Layout { get; set; }
        public DbSet<SYS_Log> SYS_Log { get; set; }
        public DbSet<SYS_Module> SYS_Module { get; set; }
        public DbSet<SYS_MSG_Message> SYS_MSG_Message { get; set; }
        public DbSet<SYS_Period> SYS_Period { get; set; }
        public DbSet<SYS_Person> SYS_Person { get; set; }
        public DbSet<SYS_Printer> SYS_Printer { get; set; }
        public DbSet<SYS_Status> SYS_Status { get; set; }
        public DbSet<SYS_Type> SYS_Type { get; set; }
        public DbSet<SYS_Version> SYS_Version { get; set; }
        public DbSet<SYS_Tracking> SYS_Tracking { get; set; }
        public DbSet<SYS_Surcharge> SYS_Surcharge { get; set; }
        public DbSet<SYS_Site> SYS_Site { get; set; }
    }
}
