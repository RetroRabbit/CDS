...
namespace CDS.Client.DataAccessLayer.DB
{
    ...
    public partial class GLX_Type : INotifyPropertyChanged, IBaseEntity
    { 
        ...
        public GLX_Type()
        {
            this.GLX_Account = new List<GLX_Account>();
            this.GLX_SystemAccountType = new List<GLX_SystemAccountType>();
        }
    	...
    	{ 
    		get { return flag1; }
    		set { SetProperty(ref flag1, value); }
    	 }
        public string Flag2 
    	{ 
    		get { return flag2; }
    		set { SetProperty(ref flag2, value); }
    	 }
    
        [System.Xml.Serialization.XmlIgnore]
    	public virtual ICollection<GLX_Account> GLX_Account { get; set; }
        [System.Xml.Serialization.XmlIgnore]
    	public virtual ICollection<GLX_SystemAccountType> GLX_SystemAccountType { get; set; }
    }
}
