...
namespace CDS.Client.DataAccessLayer.DB
{
    ...
    public partial class OrganisationEntityTables : DbContext /*ExtenderContext*/
    {
        public OrganisationEntityTables(string connection)
            : base(connection)
        {
    	}
    
    	public OrganisationEntityTables(DbConnection connection, bool ownsConnection)
            : base(connection, ownsConnection)
        {
        }
    
    	public OrganisationEntityTables()
            : base("name=OrganisationEntityTables")
        {
        }
        ...
        public DbSet<ORG_CompanyAddress> ORG_CompanyAddress { get; set; }
        public DbSet<ORG_CostCategory> ORG_CostCategory { get; set; }
        public DbSet<ORG_Department> ORG_Department { get; set; }
        public DbSet<ORG_Distribution> ORG_Distribution { get; set; }
        public DbSet<ORG_DistributionType> ORG_DistributionType { get; set; }
        public DbSet<ORG_Entity> ORG_Entity { get; set; }
        public DbSet<ORG_History> ORG_History { get; set; }
        public DbSet<ORG_PaymentTerm> ORG_PaymentTerm { get; set; }
        public DbSet<ORG_StatementPreference> ORG_StatementPreference { get; set; }
        public DbSet<ORG_TRX_Header> ORG_TRX_Header { get; set; }
        public DbSet<ORG_TRX_LostSale> ORG_TRX_LostSale { get; set; }
        public DbSet<ORG_TRX_ShippingType> ORG_TRX_ShippingType { get; set; }
        public DbSet<ORG_Type> ORG_Type { get; set; }
        public DbSet<ORG_Contact> ORG_Contact { get; set; }
    }
}
