...
namespace CDS.Client.Desktop.Essential.UTL
{
    public class CustomGridView : GridView
    {
        ...
        public DevExpress.XtraEditors.Repository.RepositoryItem PreviewRowEdit
        {
            ...
            set
            {
                if (PreviewRowEdit != value)
                {
                    ...
                    fRowPreviewEdit.AllowFocused = false;
                    fRowPreviewEdit.ReadOnly = true;
        ...
        protected internal virtual  bool IsRowPreviewSelected
        {
        ...
        protected internal virtual int RaiseMeasurePreviewHeightAccessMetod(int rowHandle) { return base.RaiseMeasurePreviewHeight(rowHandle); }
