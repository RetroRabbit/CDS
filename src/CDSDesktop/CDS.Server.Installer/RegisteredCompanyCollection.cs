...
namespace CDS.Server.Installer
{
    ...
    public class RegisteredCompanyCollection : ConfigurationElementCollection
    {
        ...
        public void NewCompany(String Name, String ConnectionString, String ConnectionTimeout, bool? updateSite)//, String entitytableconnectionstring, String entityviewconnectionstring)
        {
