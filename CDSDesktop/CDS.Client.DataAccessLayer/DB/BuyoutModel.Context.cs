...
namespace CDS.Client.DataAccessLayer.DB
{
    ...
    public partial class BuyoutEntityTables : DbContext /*ExtenderContext*/
    {
        public BuyoutEntityTables(string connection)
            : base(connection)
        {
    	}
    
    	public BuyoutEntityTables(DbConnection connection, bool ownsConnection)
            : base(connection, ownsConnection)
        {
        }
    
    	public BuyoutEntityTables()
            : base("name=BuyoutEntityTables")
        {
        }
        ...
        public DbSet<IBO_TRX_Header> IBO_TRX_Header { get; set; }
    }
}
