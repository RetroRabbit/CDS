...
namespace CDS.Client.DataAccessLayer.DB
{
    ...
    public partial class ReportEntityTables : DbContext /*ExtenderContext*/
    {
        public ReportEntityTables(string connection)
            : base(connection)
        {
    	}
    
    	public ReportEntityTables(DbConnection connection, bool ownsConnection)
            : base(connection, ownsConnection)
        {
        }
    
    	public ReportEntityTables()
            : base("name=ReportEntityTables")
        {
        }
        ...
        public DbSet<RPT_Analytic> RPT_Analytic { get; set; }
        public DbSet<RPT_Report> RPT_Report { get; set; }
    }
}
