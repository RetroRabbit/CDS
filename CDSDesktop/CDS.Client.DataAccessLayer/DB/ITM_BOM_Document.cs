...
namespace CDS.Client.DataAccessLayer.DB
{
    ...
    public partial class ITM_BOM_Document : INotifyPropertyChanged, IBaseEntity
    { 
        ...
        private decimal quantityExpectedResult;
        private Nullable<decimal> quantityActualResult;
    	...
    	{ 
    		get { return quantityExpectedResult; }
    		set { SetProperty(ref quantityExpectedResult, value); }
    	 }
        public Nullable<decimal> QuantityActualResult 
    	{ 
    		get { return quantityActualResult; }
    		set { SetProperty(ref quantityActualResult, value); }
    	 }
