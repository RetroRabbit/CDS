...
namespace CDS.Client.DataAccessLayer.DB
{
    ...
    public partial class WorkshopEntityTables : DbContext /*ExtenderContext*/
    {
        public WorkshopEntityTables(string connection)
            : base(connection)
        {
    	}
    
    	public WorkshopEntityTables(DbConnection connection, bool ownsConnection)
            : base(connection, ownsConnection)
        {
        }
    
    	public WorkshopEntityTables()
            : base("name=WorkshopEntityTables")
        {
        }
        ...
        public DbSet<JOB_Header> JOB_Header { get; set; }
    }
}
