...
namespace CDS.Client.DataAccessLayer.DB
{
    ...
    public partial class ITM_DIS_AmountType : INotifyPropertyChanged, IBaseEntity
    { 
        ...
        public ITM_DIS_AmountType()
        {
            this.ITM_DIS_Discount = new List<ITM_DIS_Discount>();
        }
    	...
    	public virtual ICollection<ITM_DIS_Discount> ITM_DIS_Discount { get; set; }
    }
}
