...
namespace CDS.Client.DataAccessLayer.DB
{
    ...
    public partial class GLX_JournalType : INotifyPropertyChanged, IBaseEntity
    { 
        ...
        public GLX_JournalType()
        {
            this.GLX_Header = new List<GLX_Header>();
        }
    	...
    	public virtual ICollection<GLX_Header> GLX_Header { get; set; }
    }
}
