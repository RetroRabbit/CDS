...
namespace CDS.Client.DataAccessLayer.DB
{
    ...
    public partial class GLX_Tax : INotifyPropertyChanged, IBaseEntity
    { 
        ...
        public GLX_Tax()
        {
            this.GLX_BulkEntryRule = new List<GLX_BulkEntryRule>();
    	...
    	public virtual ICollection<GLX_BulkEntryRule> GLX_BulkEntryRule { get; set; }
        [System.Xml.Serialization.XmlIgnore]
