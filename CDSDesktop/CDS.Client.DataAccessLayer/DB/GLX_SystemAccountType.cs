...
namespace CDS.Client.DataAccessLayer.DB
{
    ...
    public partial class GLX_SystemAccountType : INotifyPropertyChanged, IBaseEntity
    { 
        ...
        public GLX_SystemAccountType()
        {
            this.GLX_SiteAccount = new List<GLX_SiteAccount>();
        }
    	...
    	public virtual ICollection<GLX_SiteAccount> GLX_SiteAccount { get; set; }
