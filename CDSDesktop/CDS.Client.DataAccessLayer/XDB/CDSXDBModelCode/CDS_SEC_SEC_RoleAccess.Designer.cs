...
namespace CDS.Client.DataAccessLayer.XDB
{
    ...
    public partial class CDS_SEC_SEC_RoleAccess : XPLiteObject
    {
        long _Id;
        [Key(true)]
        public long Id
        ...
        [Association(@"CDS_SEC_SEC_RoleAccessReferencesCDS_SEC_SEC_Role")]
        public CDS_SEC_SEC_Role RoleId
        {
            get { return _RoleId; }
            set { SetPropertyValue<CDS_SEC_SEC_Role>("RoleId", ref _RoleId, value); }
        }
        CDS_SEC_SEC_Access _AccessId;
        [Association(@"CDS_SEC_SEC_RoleAccessReferencesCDS_SEC_SEC_Access")]
        public CDS_SEC_SEC_Access AccessId
        {
            get { return _AccessId; }
            set { SetPropertyValue<CDS_SEC_SEC_Access>("AccessId", ref _AccessId, value); }
        }
        DateTime _CreatedOn;
        ...
        [Association(@"CDS_SEC_SEC_RoleAccessReferencesCDS_SYS_SYS_Person")]
