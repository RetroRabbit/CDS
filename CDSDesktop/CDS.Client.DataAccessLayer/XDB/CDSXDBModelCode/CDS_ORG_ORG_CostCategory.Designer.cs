...
namespace CDS.Client.DataAccessLayer.XDB
{
    ...
    public partial class CDS_ORG_ORG_CostCategory : XPLiteObject
    {
        byte _Id;
        [Key]
        public byte Id
        ...
        [Association(@"CDS_ORG_ORG_CompanyReferencesCDS_ORG_ORG_CostCategory", typeof(CDS_ORG_ORG_Company))]
