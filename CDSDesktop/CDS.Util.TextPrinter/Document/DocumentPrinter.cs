...
namespace CDS.Util.TextPrinter.Document
{
    public class DocumentPrinter
    {
        private static DocumentPrinter instance;

        public static DocumentPrinter Instance
        {
            get
            {
                if (instance == null) instance = new DocumentPrinter();
                return instance;
            }
        }
        ...
        private void LoadData(XmlNode section, Int64 documentId, String connectionstring)
        {
            ...
            {
                SqlDataAdapter adapter = new SqlDataAdapter(dataset.InnerText.Replace("[Parameter01]", String.Format("'{0}'", documentId)), connection);
